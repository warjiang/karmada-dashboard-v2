...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&o.EnableMetricsScraperProxy, "enable-metrics-scraper-proxy", true, "whether enable proxy to karmada-dashboard-metrics-scraper, if set true, all requests with /metrics-scraper prefix will be proxied to karmada-dashboard-metrics-scraper.karmada-system.svc.cluster.local")
