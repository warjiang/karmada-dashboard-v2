...
function usage() {
  echo "Generate and apply an independent kubeconfig secret for Karmada Dashboard."
  echo "Usage: hack/deploy-karmada-dashboard.sh <HOST_CLUSTER_KUBECONFIG> <HOST_CONTEXT_NAME>"
  echo "Example: hack/deploy-karmada-dashboard.sh ~/.kube/karmada.config karmada-host"
}
